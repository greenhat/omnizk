    ...
    check_wasm(
        ...
        expect![[r#"
            (module
              ...
              (func $_ZN28c2zk_rust_wasm_tests_bundle13add3add17h1d8242aadf5ab846E (;3;) (type 3) (param i64 i64) (result i64)
                local.get 1
                local.get 0
                i64.add
              )
              (func $_ZN28c2zk_rust_wasm_tests_bundle13add4main17hb9ca2d9cba28e087E (;4;) (type 2)
